# Contributing to Endless Host Roles (EHR)
...
- This project uses a **single branch** (usually `main`).  
- Pull Requests (PRs) should **squash commits** before merging.  
