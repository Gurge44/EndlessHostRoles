...
public static class DevManager
{
    ...
    public static void Init()
    {
        ...
        // EHR players
        DevUserList.Add(new(code: "ravenknurl#4562", color: "#008000", tag: "DESUMILDE QUE NUNCA DEU ADM NO SERVIDOR DE MODS DELE PRO RAFAEL(LINDO)", isUp: false, isDev: false, deBug: false, colorCmd: false, upName: "RicardoFumante"));
        ...
        DevUserList.Add(new(code: "frizzytram#2508", color: "#1C87FF", tag: "Maconheiro do Youtube rei delas <sprite=1> <#ff0000>fh chupe meu pinto", isUp: true, isDev: false, deBug: false, colorCmd: false, upName: "RafaelBIT50"));
