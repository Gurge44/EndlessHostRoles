...
public static class NameColorManager
{
    ...
    private static bool KnowTargetRoleColor(PlayerControl seer, PlayerControl target, bool isMeeting, out string color)
    {
        ...
        return seer == target
               ...
               || (Main.PlayerStates[seer.Data.PlayerId].IsDead && seer.Data.IsDead && !seer.IsAlive() && Options.GhostCanSeeOtherRoles.GetBool() && (!Altruist.On || !Main.DiedThisRound.Contains(seer.PlayerId)))
