...
internal static class CustomRolesHelper
{
    ...
    public static RoleTypes GetDYRole(this CustomRoles role)
    {
        return role switch
        {
            ...
            CustomRoles.Gaulois => RoleTypes.Impostor,
    ...
    public static bool CheckAddonConflict(CustomRoles role, PlayerControl pc)
    {
        ...
        if (role is CustomRoles.Flashman && pc.GetCustomRole() is CustomRoles.Swooper or CustomRoles.Wraith or CustomRoles.Chameleon or CustomRoles.Alchemist) return false;
