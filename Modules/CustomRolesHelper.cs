...
internal static class CustomRolesHelper
{
    ...
    {
        return CheckAddonConflict(role, pc, validateExistingState: false);
    }

    public static bool IsAddonCompatibleWithCurrentState(CustomRoles role, PlayerControl pc)
    {
        return CheckAddonConflict(role, pc, validateExistingState: true);
    }

    private static bool CheckAddonConflict(CustomRoles role, PlayerControl pc, bool validateExistingState)
    {
