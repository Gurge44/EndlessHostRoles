...
internal static class ChatCommands
{
    ...
    public static void LoadCommands()
    {
        ...
        [
            ...
            new(["kcount", "кубийц"], "", GetString("CommandDescription.KCount"), Command.UsageLevels.Everyone, Command.UsageTimes.InMeeting, KCountCommand, true),
            ...
            new(["vote", "голос", "проголосовать"], "{id}", GetString("CommandDescription.Vote"), Command.UsageLevels.Everyone, Command.UsageTimes.InMeeting, VoteCommand, true, [GetString("CommandArgs.Vote.Id")]),
...
internal class UpdateCharCountPatch
{
    public static void Postfix(FreeChatInputField __instance)
    {
        ...
        __instance.charCountText.SetText(length <= 0 ? "Thank you for using EHR!" : $"{length}/{__instance.textArea.characterLimit}"); //HyperAtill: How to make there also ru variant of this? It will be "Спасибо за использование EHR!"
