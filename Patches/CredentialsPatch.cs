...
#pragma warning restore CS0162 // Unreachable code detected
        ...
        Main.CredentialsText = $"<color={Main.ModColor}>Endless Host Roles</color> v{Main.PluginDisplayVersion} Optimization Test V3{testBuildIndicator} <color=#a54aff>by</color> <color=#ffff00>Gurge44</color>";
