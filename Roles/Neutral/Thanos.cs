...
public class Thanos : RoleBase
{
    ...
    public override string GetSuffix(PlayerControl seer, PlayerControl target, bool hud = false, bool meeting = false)
    {
        ...
        {
            string action = Translator.GetString(Options.UsePhantomBasis.GetBool() && Options.UsePhantomBasisForNKs.GetBool() ? "AbilityButtonText.Thanks" : Options.UsePets.GetBool() ? "PetButtonText" : "Shapeshift");
