...
namespace EHR.Neutral
{
    public class Totocalcio : RoleBase
    {
        ...
        public static void ReceiveRPC(MessageReader reader)
        {
            ...
            if (Main.PlayerStates[PlayerId].Role is not Totocalcio tc)
            {
                return;
            }
        ...
        public static string TargetMark(PlayerControl seer, PlayerControl target)
        {
            if (!seer.Is(CustomRoles.Totocalcio))
            {
                ...
                if (Main.PlayerStates[target.PlayerId].Role is not Totocalcio tc)
                {
                    return string.Empty;
                }
            ...
            {
                if (Main.PlayerStates[seer.PlayerId].Role is not Totocalcio tc)
                {
                    return string.Empty;
                }
