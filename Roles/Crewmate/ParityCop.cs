        ...
        switch (operate)
        {
            ...
            case 2:
            {
                ...
                if (target1 != null && target2 != null)
                {
                    ...
                    if (((target1.Is(Team.Impostor) || target1.GetCustomSubRoles().Any(role => role.IsImpostorTeamV2())) && (target2.Is(Team.Impostor) || target2.GetCustomSubRoles().Any(role => role.IsImpostorTeamV2()))) ||
