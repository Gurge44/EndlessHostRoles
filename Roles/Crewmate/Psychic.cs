...
namespace EHR.Crewmate
{
    public class Psychic : RoleBase
    {
        ...
        public static void ReceiveRPC(MessageReader reader)
        {
            ...
            if (Main.PlayerStates[playerId].Role is not Psychic ph)
            {
                return;
            }
        ...
        public static bool IsRedForPsy(PlayerControl target, PlayerControl seer)
        {
            ...
            if (Main.PlayerStates[seer.PlayerId].Role is not Psychic ph)
            {
                return false;
            }
            ...
            {
                return target.GetCustomRole().IsNeutral() || target.GetCustomRole().GetCrewmateRoleCategory() == RoleOptionType.Crewmate_Killing;
            }
        ...
        {
            if (!IsEnable || !AmongUsClient.Instance.AmHost)
            {
                return;
            }
