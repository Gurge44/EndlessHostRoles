...
public static class Deathrace
{
    ...
    public static readonly Dictionary<MapNames, List<SystemTypes>> Tracks = new()
    {
        ...
        [MapNames.Fungle] = [SystemTypes.Cafeteria, (SystemTypes)100 /* Coordinate check point (Left side of Cafeteria > Splash Zone passthrough) */, SystemTypes.RecRoom, SystemTypes.Greenhouse, SystemTypes.UpperEngine, /* Vent */ SystemTypes.Storage],
        [(MapNames)6] = [(SystemTypes)SubmergedCompatibility.SubmergedSystemTypes.UpperCentral, SystemTypes.Cafeteria, (SystemTypes)SubmergedCompatibility.SubmergedSystemTypes.UpperCentral, (SystemTypes)SubmergedCompatibility.SubmergedSystemTypes.UpperLobby, (SystemTypes)SubmergedCompatibility.SubmergedSystemTypes.LowerLobby, SystemTypes.Storage, (SystemTypes)SubmergedCompatibility.SubmergedSystemTypes.LowerCentral, (SystemTypes)SubmergedCompatibility.SubmergedSystemTypes.Filtration, SystemTypes.Electrical, (SystemTypes)SubmergedCompatibility.SubmergedSystemTypes.LowerCentral, (SystemTypes)SubmergedCompatibility.SubmergedSystemTypes.Ballast, (SystemTypes)SubmergedCompatibility.SubmergedSystemTypes.LowerLobby, (SystemTypes)SubmergedCompatibility.SubmergedSystemTypes.UpperLobby] // TODO: ELEVATORS & DECON? + POS CHECK ON UPPER DECK: CENTRAL -> CAF
    };

    public static readonly Dictionary<int, Vector2> CoordinateChecks = new()
    {
        [100] = new Vector2(-22f, 1.82f)
    };
